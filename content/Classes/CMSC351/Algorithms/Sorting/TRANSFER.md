...
Now notice for a list of length $n$, there are $n!$ possible sortings (permutations) of thelist that can be returned. In our decision tree, this gives us $n!$ leaves.
